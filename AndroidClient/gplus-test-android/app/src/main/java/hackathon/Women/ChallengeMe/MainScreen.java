...
public class MainScreen extends Activity {
	...
	public void onProfileClick(View view){
		 ...
		 * 
		 */
		Intent profilePage = new Intent(this, hackathon.women.challengeme.MyProfile.class);
	...
	public void onYesButtonClick(View view){
		...
		Intent challengePage = new Intent(this, hackathon.women.challengeme.ChooseChallenge.class);
