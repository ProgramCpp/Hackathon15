...
public class MyProfile extends FragmentActivity implements
	...
	public void myTrophyRoomButtonClick(View view){
		...
		Intent challengeOpponentPage = new Intent(this, hackathon.women.challengeme.MyTrophyRoom.class);
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mimgProfilePic = (ImageView) findViewById(R.id.Profile_Pic);
